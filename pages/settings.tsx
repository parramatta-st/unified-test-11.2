...
type SettingsApiResponse = { ok?: boolean; error?: string; settings?: Partial<PrintSettings>; campusKey?: string; configured?: { csv?: boolean; webhook?: boolean; envJson?: boolean }; loadedFromCsv?: boolean; warning?: string };
...
export default function SettingsPage() {
  ...
  async function save() {
    ...
    try {
      ...
      setMessage('Print colour settings saved. Google Sheets published CSVs can take a short moment to refresh.');
